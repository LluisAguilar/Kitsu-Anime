...
class MangaArticleRecyclerAdapter(private var mArticlesList: ArrayList<ArticleDataUI>?, private val mResourceItemId:Int, listener: OnArticleItemClickListener):
